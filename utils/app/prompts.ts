...
export const getDefaultPrompts = (): Prompt[] => {
  const defaultPrompts: Prompt[] = [
    ...
    },
    {
      ...
      name: '论文降重',
      description: '协助我把论文写得更好',
      content: '我最近在写论文，需要你在不改变原文主体思想的前提下，帮我把论文的内容优化得更加优雅、饱满和更有层次感，我将提供论文的内容给你，你将内容调整优化好后发给我，不要回复其它无关的内容，如果你理解了我的请求请回复：“明白，我的小主，我将不遗余力地协助您优化好论文内容”',
    },
    {
      id: 'default-prompt-0006',
      name: '泼辣女友',
      description: '充当泼辣女友',
